...
# ---------------------------------------------------------------------------
# RFC 7030 Section 4.1 / 4.2 - Live server interaction (opt-in)
# ---------------------------------------------------------------------------
Server Must Return A Certs-Only Bundle For CACerts
    [Documentation]    RFC 7030 Section 4.1: GET /cacerts over TLS must return HTTP 200 with an
    ...    application/pkcs7-mime certs-only bundle. Requires a live EST server at ${EST_BASE_URL}.
