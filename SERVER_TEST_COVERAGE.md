...
> **Note**: These test cases are located in `tests/verbose_pkiheader_tests.robot` (generated by `scripts/generate_pkiheader_verbose_tests.py`) and cover detailed equivalence classes for PVNO validation.

| Equivalence Class | PVNO Value                       | Expected FailInfo    | Body Types Covered | File                                  |
|-------------------|----------------------------------|----------------------|--------------------|---------------------------------------|
| Negative integer  | -1                               | `unsupportedVersion` | `ir`               | `tests/verbose_pkiheader_tests.robot` |
| Zero              | 0                                | `unsupportedVersion` | `ir`               | `tests/verbose_pkiheader_tests.robot` |
| Undefined version | 4 (not 2 or 3)                   | `unsupportedVersion` | `ir`               | `tests/verbose_pkiheader_tests.robot` |
| Integer overflow  | 18446744073709551616 (too large) | `badDataFormat`      | `ir`               | `tests/verbose_pkiheader_tests.robot` |
| Legacy version    | 1                                | `unsupportedVersion` | `ir`               | `tests/verbose_pkiheader_tests.robot` |
...
- `added‑prot*` includes `added‑protection‑inner‑ir`, `added‑protection‑inner‑cr`, `added‑protection‑inner‑kur`,
  `added‑protection‑inner‑p10cr`, `added‑protection‑inner‑ccr`
...
This document summarizes which test cases in the CMP test suite cover the handling of certificate confirmation
(`certConf`) requests and PKI confirmation (`pkiconf`) responses according to
[RFC 9483](https://datatracker.ietf.org/doc/html/rfc9483).
