...
def pretty_print_chain_subject_and_issuer(cert_or_chain: Union[rfc9480.CMPCertificate, List[rfc9480.CMPCertificate]]) -> List[str]:
    ...
    :return: A list of strings containing the subject and issuer information for each certificate in the chain.
    """
...
def print_extensions(extensions: rfc9480.Extensions) -> List[str]:
