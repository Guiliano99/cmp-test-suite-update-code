...
class TestCompositeMLKEM(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.private_key_rsa_1: CompositeKEM10PrivateKey = generate_key("composite-kem10", pq_name="ml-kem-768", trad_name="rsa")

        # EC-based composite keys
        self.private_key_ec_1: CompositeKEM10PrivateKey = generate_key("composite-kem10", pq_name="ml-kem-768", curve="secp384r1")
        self.private_key_ec_2 = generate_key("ecc", curve="secp384r1")

        # X-based composite keys
        self.private_key_x_1: CompositeKEM10PrivateKey = generate_key("composite-kem10",pq_name="ml-kem-768", trad_name="x25519")
    ...
    def test_encaps_and_decaps_x448(self):
        ...
        comp_key: CompositeKEM10PrivateKey
