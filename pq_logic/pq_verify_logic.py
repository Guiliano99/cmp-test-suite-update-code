...
def _verify_signature_with_other_cert(
    ...
    if sig_alg_oid not in COMPOSITE_SIG_OID_TO_NAME:
    ...
    if sig_alg_oid in COMPOSITE_SIG_OID_TO_NAME:
...
def verify_composite_signature_with_hybrid_cert(  # noqa D417 undocumented-param
    ...
    if oid not in COMPOSITE_SIG_OID_TO_NAME:
    ...
    if cert_sig_alg in COMPOSITE_SIG_OID_TO_NAME:
